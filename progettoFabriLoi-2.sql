...
--
-- Host: localhost
-- Creato il: Giu 17, 2024 alle 12:41
...
CREATE TABLE `blog` (
  ...
  `followers_count` int(10) NOT NULL DEFAULT 0
...
CREATE TABLE `utente` (
  ...
  `pw` varchar(60) CHARACTER SET latin1 COLLATE latin1_general_cs NOT NULL,
...
ALTER TABLE `co_autore`
  ...
  ADD KEY `co_autore_ibfk_2` (`id_blog`);
...
--
ALTER TABLE `stile`
  MODIFY `id_stile` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=271;

--
-- AUTO_INCREMENT per la tabella `utente`
--
ALTER TABLE `utente`
  MODIFY `id_utente` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
